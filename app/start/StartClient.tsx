        ...
        {!done ? (
          ...
          <div className="animate-[startFade_0.5s_ease-out_both] py-6 md:py-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-3 justify-center">
              ...
              <a
                href="tel:+359882251474"
                className="inline-flex items-center justify-center gap-2 border border-[#c8ff00]/50 text-[#c8ff00] font-semibold px-8 py-3.5 rounded-full hover:bg-[#c8ff00]/10 transition-colors"
              >
