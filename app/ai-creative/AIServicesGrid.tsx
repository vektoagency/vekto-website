...
// The four AI-focused services that used to live on the homepage
// before the umbrella repositioning. Moved here so the home page
// can lead with the growth-partner claim and this subpage handles
// the deep AI creative pitch for visitors who arrive with that
// specific intent (Meta ads on AI-video creatives, referrals from
// the AI creative work, etc.).

const dict = {
  bg: {
    eyebrow: "AI CREATIVE PILLARS",
    ...
    services: [
      {
        ...
        description:
          "Кратки силни видеа, които правят бизнеса ти експерт в твоята сфера. Стигат до повече хора и държат вниманието им.",
      ...
      },
      {
        ...
        description:
          "Премиум филми с пълен процес — от идея до финален монтаж. AI добавя кинематографично качество от висок клас.",
      ...
      },
      {
        ...
        description:
          "Реалистични AI визуализации за продукти — готови за онлайн магазини и реклами. Премиум визия, която продава.",
    ...
    services: [
      {
        ...
        image: "/images/service-1.webp",
        description:
          "Engaging, high-impact short-form videos for social media that position your brand as an authority in your space — optimized for maximum reach and engagement.",
      ...
      },
      {
        ...
        image: "/images/service-3.webp",
        description:
          "High-end immersive storytelling with full production pipeline from concept to post-processing. AI-enhanced for a premium cinematic finish.",
      ...
      },
      {
        ...
        image: "/images/service-4.webp",
        description:
          "Hyper-realistic AI-enhanced product visuals optimized for eCommerce and marketing assets. Premium presentation that converts.",
...
export default function AIServicesGrid() {
  ...
  return (
    <section
      ...
      style={{ background: "linear-gradient(to bottom, #080808, #0a0a0f, #080808)" }}
    >
      <div className="max-w-7xl mx-auto">
        <AnimateIn className="flex flex-col md:flex-row md:items-end justify-between gap-5 mb-10 md:mb-16">
          ...
          <p className="max-w-sm text-[#a0a0a0] text-sm md:text-base leading-relaxed text-balance">
            {t.sub}
          </p>
        </AnimateIn>

        {/* Desktop layout — sticky preview image + hoverable list */}
                    ...
                    >
                      ...
                      <div className="flex flex-wrap gap-2">
                        {s.tags.map((tag) => (
                          <span
                            key={tag}
                            className="text-xs border border-[#333] text-[#666] px-3 py-1 rounded-full"
                          >
                            {tag}
                          </span>
                        ))}
            ...
            <AnimateIn key={s.number} delay={i * 80}>
              <div className="group py-6">
                ...
                <div className="flex items-start gap-3.5">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2 text-balance leading-snug">
                      {s.title}
                    </h3>
                    <p className="text-[#a0a0a0] text-[13px] leading-relaxed mb-3 text-balance">
                      {s.description}
                    </p>
                    <div className="flex flex-wrap gap-1.5">
                      {s.tags.map((tag) => (
                        <span
                          key={tag}
                          className="text-[10px] border border-[#222] text-[#888] px-2.5 py-0.5 rounded-full"
                        >
                          {tag}
                        </span>
                      ))}
