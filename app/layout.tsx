...
export const metadata: Metadata = {
  ...
  description:
    "Реклами, съдържание, уебсайтове и стратегия — под един покрив. 50+ бизнеса в България и САЩ. 4.8× среден ROAS.",
  openGraph: {
    title: "VEKTO — Независима агенция за растеж",
    description:
      "Реклами, съдържание, уебсайтове и стратегия — под един покрив. 50+ бизнеса в България и САЩ. 4.8× среден ROAS.",
  ...
  twitter: {
    ...
    title: "VEKTO — Независима агенция за растеж",
    description:
      "Реклами, съдържание, уебсайтове, стратегия — под един покрив. 50+ бизнеса, 4.8× ROAS.",
  },
};
