...
export const metadata: Metadata = {
  ...
  description:
    "Един екип за криейтиви, фунии и AI решения. 50+ бранда в портфолиото, 500+ видеа на месец. Запази 30-минутен разговор — безплатно.",
  openGraph: {
    title: "VEKTO — Криейтиви, фунии и AI под един покрив",
    description:
      "Един екип за криейтиви, фунии и AI решения. 50+ бранда в портфолиото, 500+ видеа на месец.",
