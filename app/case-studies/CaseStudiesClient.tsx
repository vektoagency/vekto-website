...
const copy = {
  bg: {
    ...
    sub: "50+ бранда в България и САЩ. Всеки кейс тук е партньорство — от бриф до launch и след него.",
    stats: [
      { value: "50+", label: "Партньорства" },
      { value: "4.8×", label: "Среден ROAS" },
      { value: "€3M+", label: "Приходи за клиенти" },
    ],
    viewCase: "Виж кейса",
    comingSoon: "Скоро",
  ...
  en: {
    ...
    stats: [
      ...
      { value: "$3M+", label: "Revenue for clients" },
    ],
    viewCase: "View case",
