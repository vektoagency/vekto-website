        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <AnimateIn from="left">
            ...
            <p className="text-[#a0a0a0] leading-relaxed mb-10 max-w-md">
              Tell us about your brand and goals. We&apos;ll put together a personalized proposal
          ...
          <AnimateIn from="right">
            <div className="bg-[#0d0d0d] border border-[#1a1a1a] rounded-2xl p-8 shadow-[0_0_40px_rgba(200,255,0,0.03)]">
              {sent ? (
