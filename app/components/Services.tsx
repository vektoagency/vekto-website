    ...
    services: [
      {
        ...
        description: "Кратки видеа с висок ефект, които позиционират бизнеса ти като експерт в неговата сфера — оптимизирани за максимален обхват и реакция.",
      ...
      },
      {
        ...
        description: "Персонални AI аватари за представяне на бизнеса ти. Доставяме съдържание на различни езици с постоянно качество — без нужда от студио.",
