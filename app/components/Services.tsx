...
const dict = {
  bg: {
    ...
    h2: ["Услуги, които", "издигат бранда ти"],
    ...
    services: [
      {
        ...
        description: "Кратки видеа с висок ефект, които позиционират бранда ти като експерт в неговата сфера — оптимизирани за максимален обхват и реакция.",
        tags: ["Социални мрежи", "Кратки формати", "Стратегия"],
      },
      {
        number: "02",
        title: "AI аватари и виртуални говорители",
        image: "/images/service-2.webp",
        description: "Персонални AI аватари за представяне на бранда ти. Доставяме съдържание на различни езици с постоянно качество — без нужда от студио.",
        tags: ["AI аватар", "Многоезичен", "Автоматизация"],
      },
      {
        number: "03",
        title: "Кинематографични филми за брандове",
        image: "/images/service-3.webp",
        description: "Висококачествено разказване с пълен продукционен процес — от концепция до пост-продукция. Подсилено с AI за кинематографично завършване от премиум клас.",
        tags: ["Кинематографичен", "Бранд филм", "Продукция"],
      },
      {
        number: "04",
        title: "AI визуализации на продукти",
        image: "/images/service-4.webp",
        description: "Хипер-реалистични продуктови визуализации, подсилени с AI — оптимизирани за онлайн магазини и реклами. Премиум представяне, което продава.",
