...
// target.y sits between the earlier -0.45 (Mac too high, bumped H1) and
// -0.12 (Mac too low) — this keeps the Mac roughly centered in the
// portrait frame with breathing room above for the H1.
const MOBILE_IDLE_TARGET = new THREE.Vector3(-0.37, -0.30, 0.3);
