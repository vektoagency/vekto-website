    ...
    steps: [
      {
        ...
        bullets: ["Преглед на бранда + аудиторията", "Анализ на конкуренти", "Позициониране"],
      },
      {
        number: "02",
        tag: "Стратегия",
        title: "Идеи и фуния, начертани докрай",
        body: "Изграждаме креативна система — банка от куки, серийни формати и пълния път от първи скрол до продажба. Без случайни опити.",
