...
const dict = {
  bg: {
    eyebrow: "Как работим",
    h2: ["От първия разговор", "до съдържание, което расте"],
    ...
    steps: [
      {
        number: "01",
        tag: "Запознаване",
        title: "Опознаваме бизнеса ти отвътре",
        body: "Подробен разговор, преглед на текущото ти съдържание и позициониране, и ясна задача за аудиторията, която искаме да привлечем.",
        bullets: ["Преглед на бизнеса и аудиторията", "Анализ на конкуренти", "Позициониране"],
      },
      {
        number: "02",
        tag: "Стратегия",
        title: "Идеи и път до продажба",
        body: "Изграждаме креативна стратегия — арсенал от идеи и закачки, формати за серии и ясен път от първото видео до покупката. Без случайни експерименти.",
        bullets: ["Идеи и закачки", "Формати за серии", "Маркетингова фуния"],
      },
      {
        number: "03",
        tag: "Продукция",
        title: "AI + кинематографична продукция",
        body: "Вътрешният ни процес съчетава AI визуализации, истински кадри и кинематографична режисура — бързо производство, без бавенето на типичните агенции.",
        bullets: ["Кадри с AI", "Кинематографична режисура", "Седмично производство"],
      },
      {
        number: "04",
        tag: "Растеж",
        title: "Пускаме, измерваме, удвояваме",
        body: "Следим какво работи, спираме това, което не — и удвояваме това, което носи резултат. Съдържанието става двигател за растеж, не разход.",
        bullets: ["Измерване на резултати", "Удвояване на печелившото", "Тримесечен преглед"],
      },
    ],
  },
  en: {
