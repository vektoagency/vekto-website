    ...
    steps: [
      {
        ...
        body: "Започваме с разговор и поглед на сегашното ти съдържание. Излизаме с ясна задача — за кого и защо.",
        bullets: ["Преглед на бизнеса", "Поглед на конкурентите", "Идея за марката"],
      },
      {
        number: "02",
        tag: "Стратегия",
        title: "Идеи и път до продажба",
        body: "Правим креативна стратегия — идеи, формати и ясен път от първото видео до покупката. Без случайни опити.",
        bullets: ["Креативни концепции", "Серии видеа", "Път до продажба"],
      },
      {
        number: "03",
        tag: "Продукция",
        title: "AI + кинематографична работа",
        body: "Съчетаваме AI с истински кадри и кинематографична визия. Бързо производство — без бавенето на агенциите.",
        bullets: ["Кадри с AI", "Кинематографична визия", "Седмично производство"],
      },
      {
        number: "04",
        tag: "Растеж",
        title: "Пускаме, измерваме, удвояваме",
        body: "Следим какво работи, спираме това, което не — и удвояваме победителите. Съдържанието става двигател за растеж, не разход.",
        bullets: ["Измерване на резултати", "Удвояване на най-силните", "Постоянна оптимизация"],
      },
    ],
  },
  en: {
    ...
    steps: [
      ...
      },
      {
        ...
        bullets: ["Performance tracking", "Winner compounding", "Continuous optimisation"],
      },
    ],
  },
};
