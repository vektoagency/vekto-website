  ...
  bg: {
    ...
    steps: [
      ...
      },
      {
        number: "02",
        tag: "Стратегия",
        title: "Идеи и пътека до продажба",
        body: "Изграждаме креативна система — банка от куки, серийни формати и пълен път от първи скрол до продажба. Без случайни опити.",
        bullets: ["Куки и креативни идеи", "Серийни формати", "Маркетингова фуния"],
      },
      {
        number: "03",
        tag: "Продукция",
        title: "AI + кинематографична продукция",
        body: "Нашата вътрешна система съчетава AI визуализации, истински кадри и кинематографична режисура — бързо производство, без бавенето на типичните агенции.",
        bullets: ["AI-подсилени кадри", "Кинематографична режисура", "Седмично производство"],
      },
      {
        number: "04",
        tag: "Растеж",
        title: "Пускаме, измерваме, удвояваме",
        body: "Следим какво работи, премахваме това, което не — и удвояваме победителите. Съдържанието става двигател за растеж, не разход.",
        bullets: ["Измерване на резултати", "Удвояване на печелившите", "Тримесечен преглед"],
      },
    ],
  },
  en: {
