      ...
      <div className="max-w-7xl mx-auto">
        ...
        <AnimateIn>
          <div className="bg-[#0d0d0d] border border-[#1a1a1a] rounded-2xl p-6 md:p-8 mb-12 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8">
            ...
            <div className="text-center">
              <div style={{ width: 80, height: 30, backgroundColor: "#c8ff00", maskImage: "url('/images/logo.webp')", maskSize: "contain", maskRepeat: "no-repeat", maskPosition: "center", WebkitMaskImage: "url('/images/logo.webp')", WebkitMaskSize: "contain", WebkitMaskRepeat: "no-repeat", WebkitMaskPosition: "center", margin: "0 auto 8px" }} />
        ...
        <AnimateIn className="text-center">
          <p className="text-[#a0a0a0] mb-6">Book a meeting and we&apos;ll tailor a plan around <span className="text-white font-medium">your goals, timeline, and budget</span> — no commitment, no pressure.</p>
          <a
            href="#contact"
