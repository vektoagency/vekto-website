...
export default function Hero() {
  ...
  const t = useT({
    bg: {
      ...
      sub: "Реклами, криейтиви, фунии и стратегия — цялата ти система за растеж на едно място. 50+ бизнеса в България и САЩ.",
    ...
    en: {
      ...
      sub: "PPC + Creative + Funnels + Strategy — your full growth system under one roof. 50+ businesses across Bulgaria and the US.",
