...
const dict = {
  bg: {
    eyebrow: "Защо VEKTO",
    h2: ["Креативният партньор,", "който бранда ти заслужава"],
    pillars: [
      ...
      { icon: "🎯", title: "Стратегическа креативност", description: "Всяко парче съдържание е създадено с цел — да продава, ангажира и развие бранда ти." },
      { icon: "🤖", title: "AI в основата", description: "Не лепим AI върху стари процеси. Целият ни работен процес е построен около AI от самото начало." },
      { icon: "🌍", title: "На всеки език", description: "Достигни глобална аудитория с AI аватари и съдържание, което говори всеки език естествено." },
    ],
    compareH3: "Как се сравняваме",
    swipeHint: "← плъзни, за да сравниш →",
    headers: { aspect: "Параметър", vekto: "VEKTO", traditional: "Традиционна агенция", inhouse: "Вътрешен екип" },
    rows: [
      { aspect: "Скорост", vekto: "2–3 дни", traditional: "2–4 седмици", inhouse: "1–2 седмици" },
      { aspect: "Цена", vekto: "Предвидима и оптимална", traditional: "Висока и непредвидима", inhouse: "Висок постоянен разход" },
      { aspect: "Качество", vekto: "AI + човешко майсторство", traditional: "Само човешко", inhouse: "Различно" },
      { aspect: "Постоянство на бранда", vekto: "AI следи", traditional: "Ръчно", inhouse: "Различно" },
      { aspect: "Достъпност", vekto: "24/7", traditional: "Работно време", inhouse: "Работно време" },
      { aspect: "Езици", vekto: "Многоезично", traditional: "Доплащане", inhouse: "Рядко" },
    ],
  },
  en: {
    eyebrow: "Why VEKTO",
