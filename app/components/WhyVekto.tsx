...
const dict = {
  bg: {
    ...
    pillars: [
      { icon: "⚡", title: "Бързо и в обем", description: "Процеси, движени от AI, ни позволяват да доставяме съдържание за дни. Без чакане, без забавяне — само резултати." },
      { icon: "🎯", title: "Креативност с цел", description: "Всяко наше видео е направено с конкретна задача — да продава, да ангажира и да помага на бизнеса ти да расте." },
      { icon: "🤖", title: "AI в основата", description: "Не закачаме AI отгоре на стари процеси. Целият ни работен метод е изграден около AI още от самото начало." },
      { icon: "🌍", title: "На всеки език", description: "Достигаме до глобална аудитория чрез AI аватари и съдържание, което звучи естествено на всеки език." },
    ],
