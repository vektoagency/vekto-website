      ...
      items: [
        {
          ...
          body: "Единични страници за реклама, кампания или продукт. Фокус върху една цел — конверсия. Готови за A/B тест и проследяване през Meta и Google.",
          tags: ["Next.js", "A/B тестове", "Проследяване на конверсии"],
        },
        {
          number: "02",
          ...
          tags: ["CMS", "Многоезичен", "Готов за SEO"],
        },
        {
          number: "03",
          title: "Електронни магазини",
          body: "Shopify, WooCommerce или самостоятелен магазин на Next.js — според мащаба. Пълна интеграция с плащания, доставки, склад, email flows.",
          tags: ["Shopify", "Headless", "Плащания", "Email"],
        },
        {
          number: "04",
          title: "Портали и приложения",
          body: "Клиентски портали, сайтове с абонамент, табла с данни, инструменти за самообслужване. Вход с профили, база данни, admin панел — end-to-end.",
          tags: ["Профили", "Database", "Admin"],
        },
      ],
    },
    process: {
      eyebrow: "ПРОЦЕС",
      h2: "От бриф до пускане за 3-6 седмици",
      steps: [
        {
          number: "01",
          title: "Дискавъри",
        ...
        },
        {
          ...
          body: "Разработваме на тестов адрес, който виждаш през цялото време. Ежеседмичен преглед, връзки с външни системи, съдържание.",
        },
        {
          number: "04",
          title: "Launch + optimize",
          duration: "Постоянно",
          body: "Пускане на живо, настройка на проследяването и наблюдение. Първи месец активна оптимизация на база реални данни.",
        },
      ],
    },
    stack: {
      ...
      items: [
        {
          ...
          tags: ["Next.js", "A/B testing", "Проследяване на конверсии"],
        },
        {
          number: "02",
