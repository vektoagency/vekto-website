...
export const metadata: Metadata = {
  ...
  description:
    "На тази флашка е кодът зад $1,000,000 оборот. Системата работи в САЩ с 50+ бранда. Сега я носим в България — за първите 5.",
  robots: {
  ...
  openGraph: {
    ...
    description:
      "Кодът е в тази флашка. 50+ бранда я ползват в САЩ. Първите 5 спота за България.",
    type: "website",
  },
};
