...
export const flashkaCopy = {
  bg: {
    ...
    about: {
      ...
      vektoBody: "VEKTO е маркетинг агенция от ново поколение. Работим с 50+ бизнеса в БГ и САЩ — стартъпи, e-commerce, услуги. Видео, реклами, scaling, цяла маркетинг система на едно място.",
      driveLabel: "ФЛАШКАТА",
