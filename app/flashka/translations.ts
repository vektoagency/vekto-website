...
export const flashkaCopy = {
  bg: {
    meta: {
      ...
      h1Top: "Кодът е в",
      h1Bottom: "50+ успешни бизнеса.",
      sub: "Цялата ни оперативна система — на тази флашка. Прилагаме я с 50+ бизнеса в БГ и САЩ. Сега я отваряме за нови 5 бизнеса.",
    ...
    clients: {
      ...
      sub: "От стартъпи до утвърдени бизнеси.",
    },
    ...
    about: {
      ...
      vektoBody: "VEKTO е маркетинг агенция от ново поколение. Работим с 50+ бизнеса в БГ и САЩ — стартъпи, e-commerce, услуги. Видео, реклами, scaling, цяла маркетинг система под един покрив.",
      driveLabel: "ФЛАШКАТА",
    ...
    faq: {
      ...
      items: [
        {
          q: "Защо ограничавате до 5 нови бизнеса?",
          a: "Защото onboarding-ът на нов клиент изисква 90-минутна сесия + 30 дни наблюдение от старши член на екипа. На 6-ти бизнес качеството пада. Предпочитаме 5 с резултат пред 15 със среден.",
        },
        {
