...
const ROSTER = [
  { name: "MEN'S CARE",    region: "BG" as const, logo: "/images/roster-trim/logo-menscare.png" },
  { name: "DUSQ",          region: "US" as const, logo: "/images/roster-trim/logo-dusq.png" },
  { name: "PARFEN",        region: "BG" as const, logo: "/images/roster-trim/logo-parfen.png" },
  { name: "ISOSPORT",      region: "BG" as const, logo: "/images/roster-trim/logo-isosport.png" },
  { name: "BIOTICA",       region: "BG" as const, logo: "/images/roster-trim/logo-biotica.png" },
  { name: "BULTEX",        region: "BG" as const, logo: "/images/roster-trim/logo-bultex.png" },
  { name: "НЕДЕЛЯ",        region: "BG" as const, logo: "/images/logo-nedelya.svg" },
  { name: "ANOMALY",       region: "US" as const, logo: "/images/roster-trim/logo-anomaly.png" },
  { name: "GOURMET HOUSE", region: "BG" as const, logo: "/images/roster-trim/logo-gourmethouse.png" },
  { name: "ETHAN'S",       region: "US" as const, logo: "/images/roster-trim/logo-ethans.png" },
  { name: "LUCKY ENERGY",  region: "US" as const, logo: "/images/roster-trim/logo-lucky.png" },
  { name: "NUTRIFITT",     region: "US" as const, logo: "/images/roster-trim/logo-nutrifitt.png" },
  ...
  { name: "KRISTA G",      region: "BG" as const, logo: "/images/roster-trim/logo-krista-g-2022.png" },
  ...
  { name: "ALPEN PHARMA",  region: "BG" as const, logo: "/images/roster-trim/logo-alpenpharma.png" },
  { name: "NIDO",          region: "BG" as const, logo: "/images/roster-trim/logo-nido2.png" },
  { name: "ARTE HOTEL",    region: "BG" as const, logo: "/images/roster-trim/logo-artehotel.png", invert: true },
  { name: "KASHMIR HOTEL", region: "BG" as const, logo: "/images/roster-trim/logo-kashmirhotel.png" },
